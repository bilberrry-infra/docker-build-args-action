...
const action_input_parser_1 = __importDefault(__nccwpck_require__(623));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const includeVars = action_input_parser_1.default.getInput('includeVars', {
                type: 'boolean'
            });
            const includeSecrets = action_input_parser_1.default.getInput('includeSecrets', {
                type: 'boolean'
            });
            const extraArgs = action_input_parser_1.default.getInput('extraArgs', {
                type: 'array'
            });
            if (includeVars) {
            }
